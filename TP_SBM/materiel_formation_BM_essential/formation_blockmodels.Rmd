...
sbm.tree$estimate()
save(sbm.tree, file = '../results/res_sbm_tree.Rdata')
```
...
plot.igraph(G,vertex.size=paramEstimSBMPoisson$pi*100,edge.width=abs(E(G)$weight)*1,vertex.color=1:Q, layout=layout_nicely)
``` 
![](../Plot/BMnet_tree.png)
