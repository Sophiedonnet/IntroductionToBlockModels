...
**Exercice** Test the Shiny app with your own data set or this one. 
...
See the [vignette](https://cran.r-project.org/web/packages/sbm/vignettes/Multipartite_EcologicalNetwork.html) here 
